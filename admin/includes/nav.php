			...
			<div class="collapse navbar-collapse" id="nvbCollapse">
				...
				<!-- <li class="nav-item active pl-1">
					...
					<li class="nav-item pl-1 dropdown">
						<a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle user-action"><img src="images\Untitled-1.jpg" class="avatar" alt="Avatar"> Brand Name</a>
						<ul class="dropdown-menu">
							...
							<li><a class="nav-link" href="#"><i class="fa fa-sign-in fa-fw mr-1"></i>Sign Out</a></li>
						</ul>
					</li>
				</ul>
			</div>
