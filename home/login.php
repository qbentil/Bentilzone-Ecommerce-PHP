...
<?php customerLogin(); if(isset($_SESSION['msg'])){ $msg = $_SESSION['msg'];} ?>
...
<section class="login-block">
    ...
    <div class="row">
        <div class="col-md-5 login-sec">
            <h2 class="text-center title">Customer Login</h2>
    <form class="login-form" id = "bootstrapForm" method = "post" autocomplete = "off" novalidate>
    <div class="alert-danger text-center text-danger font-weight-bold"><?php if(isset($msg)) echo $msg; ?></div>
    ...
    <div class="form-check">
        ...
        <button type="submit" class="btn btn-login float-right text-white" name = "btn_login">Sign In</button>
    </div><br clear = "all">
    <div class="adds">
